  ...
  if (isMobile) {
    return (
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-6 mx-4 animate-fade-in">
          ...
          <div className="px-6 py-8">
            <p className="font-display text-xs tracking-[0.15em] uppercase text-gold-dark mb-3 opacity-0 animate-fade-up">
              Интеллектуальный экскурс
            </p>
            
            <h1 className="font-display text-3xl font-medium tracking-wide text-sepia mb-1 opacity-0 animate-fade-up delay-100 leading-tight">
              Стратегия
            </h1>
            <h1 className="font-display text-3xl font-medium tracking-wide text-sepia mb-3 opacity-0 animate-fade-up delay-100 leading-tight">
              Наследия
            </h1>
            
            <p className="font-display text-sm italic text-sepia-light opacity-0 animate-fade-up delay-200">
              Наследие прошлого — стратегия
            </p>
            <p className="font-display text-sm italic text-sepia-light mb-4 opacity-0 animate-fade-up delay-200">
              будущего
            </p>
          </div>
        </div>
        
        {/* Button outside the card, lower on screen */}
